...
public class MagicEightBall {
	 ...
	 * following rules:
	 * 
	 * Unhappy students with less than 10 hours of study always results in "Embarrassing Michigan Road Trip". 
	 * Social happy students with more than 20 hours of CS125 study always results in "Ace CS125 Exam". 
	 * Social, unhappy students with more than 15 hours of study always results in "Rick Rolled Four Times in One Day". 
	 * All other students have their "Delete Enter Keys Swapped" by the ACM office.
	 * 
	 * @param args
	 */
	public static void main(String[] args) {
		...
		// solution.
		if(happy == false && hours < 10){
			TextIO.putln("Embarrassing Michigan Road Trip");
		}
		else
		{
			if (happy == true && social == true && hours > 20)
			{
				TextIO.putln("Ace CS125 Exam");	
			}
			else 
			{
				if(happy == false && social == true && hours > 15)
				{
