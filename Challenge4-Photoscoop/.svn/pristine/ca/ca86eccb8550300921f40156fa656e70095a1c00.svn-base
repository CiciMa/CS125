...
public class Effects {
	...
	public static int[][] process(String cmd, int[][] source, int[][] background) {
		...
		if (cmd.toLowerCase() == null){return null;}
		else if (cmd.toLowerCase().equals("copy")) {return PixelEffects.copy(source);}
		else if (cmd.toLowerCase().equals("resize")) {return PixelEffects.resize(source, background.length, background[0].length );}
		else if (cmd.toLowerCase().equals("half")) {return PixelEffects.half(source);}
		else if (cmd.toLowerCase().equals("flip")) {return PixelEffects.flip(source);}
		else if (cmd.toLowerCase().equals("rotate")) {return PixelEffects.rotateLeft(source);}
		else if (cmd.toLowerCase().equals("mirror")) {return PixelEffects.mirror(source);}
		else if (cmd.toLowerCase().equals("merge")) {return PixelEffects.merge(source, background);}
		else if (cmd.toLowerCase().equals("redeye")) {return PixelEffects.redeye(source, background);}
		else if (cmd.toLowerCase().equals("key")) {return PixelEffects.chromaKey(source, background);}
		else if (cmd.toLowerCase().equals("funky")) {return PixelEffects.funky(source, background);}
